...
//
//    //素材图片容器
//    private static Bitmap image_eye;
//    private static Bitmap image11;
//    private static Bitmap image12;
//    private static Bitmap image13;
//    private static Bitmap image21;
//    private static Bitmap image22;
//    private static Bitmap image23;
//    private static Bitmap image31;
//    private static Bitmap image32;
//    private static Bitmap image33;
//    private static Bitmap image41;
//    private static Bitmap image42;
//    private static Bitmap image43;
//
//
//    /**
//     * 生成二维码
...
//        try {
//            //加载码眼
//            image_eye = new InputStreamReader(new FileInputStream(aspath+"\\images\\ImageMaker\\"+type+"\\"+filename+"\\eye.png"));
//            //装载50*50的图片素材
...
//        Rect f = new Rect(pix, pix,pix*7, pix*7);
//        canvas.drawBitmap(image_eye, f, null, null);
//        //通用地绘制码眼
//        gs.drawImage(image_eye, pix, pix, pix*7, pix*7, null);
//        gs.drawImage(image_eye, (codeLength-7)*pix+pixoff, pix, pix*7, pix*7, null);
//        gs.drawImage(image_eye, pix, (codeLength-7)*pix+pixoff, pix*7, pix*7, null);
